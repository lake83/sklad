    ...
    <div class="tab-content">
        <div class="tab-pane active" id="control-sidebar-home-tab">
            <h3 class="control-sidebar-heading">
                Настройки
                <a class="btn btn-success pull-right" href="#" onclick="js:createSetting('Создать настройку', '<?=Url::to(['/admin/admin/create-setting'])?>');return false;">Создать</a>
            </h3>
        ...
        <div class="tab-pane" id="control-sidebar-settings-tab">
            ...
            <a class="btn btn-danger" href="<?=Url::to(['/admin/admin/clear-cache'])?>" data-confirm="Вы уверены, что хотите удалить весь кеш?">Очистить</a>
        </div>
    </div>
</aside>
